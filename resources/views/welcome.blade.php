...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    {{-- <header class="grid items-center grid-cols-2 gap-2 py-10 lg:grid-cols-3">
                        ...
                        <body class="bg-neutral-900">
                            ...
                            <header class="sticky inset-x-0 z-50 flex flex-wrap w-full top-4 md:justify-start md:flex-nowrap">
                              <nav class="relative max-w-[66rem] w-full bg-neutral-800 rounded-[28px] py-3 ps-5 pe-2 md:flex md:items-center md:justify-between md:py-0 mx-2 lg:mx-auto" aria-label="Global">
                                <div class="flex items-center justify-between">
                                  ...
                                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ff0" class="size-8">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ff0" class="size-6">
                                ...
                                <div id="navbar-collapse" class="hidden overflow-hidden transition-all duration-300 hs-collapse basis-full grow md:block">
                                  <div class="flex flex-col py-2 md:flex-row md:items-center md:justify-end md:py-0 md:ps-7">
                                    <a class="py-3 text-sm text-white ps-px sm:px-3 md:py-4 hover:text-neutral-300 focus:outline-none focus:text-neutral-300" href="../../templates/agency/index.html" aria-current="page">Home</a>
                                    <a class="py-3 text-sm text-white ps-px sm:px-3 md:py-4 hover:text-neutral-300 focus:outline-none focus:text-neutral-300" href="#">Stories</a>
                                    <a class="py-3 text-sm text-white ps-px sm:px-3 md:py-4 hover:text-neutral-300 focus:outline-none focus:text-neutral-300" href="#">Reviews</a>
                                    <a class="py-3 text-sm text-white ps-px sm:px-3 md:py-4 hover:text-neutral-300 focus:outline-none focus:text-neutral-300" href="#">Approach</a>

                                    <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] py-3 ps-px sm:px-3 md:py-4">
                                      ...
                                      <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-neutral-800 md:shadow-md rounded-lg p-2 before:absolute top-full before:-top-5 before:start-0 before:w-full before:h-5">
                                        ...
                                        <div class="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover] relative">
                                          ...
                                          <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 md:mt-2 bg-neutral-800 md:shadow-md rounded-lg p-2 before:absolute before:-end-5 before:top-0 before:h-full before:w-5 !mx-[10px] top-0 end-full">
                                            <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-white hover:text-neutral-300 font-medium focus:outline-none focus:text-neutral-300" href="#">
                                              About
                                            </a>
                                            <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-white hover:text-neutral-300 font-medium focus:outline-none focus:text-neutral-300" href="#">
                            ...
                            <main id="content">
                              ...
                              <div class="bg-neutral-900">
                                <div class="max-w-5xl px-4 pt-24 pb-24 mx-auto xl:px-0 lg:pt-32">
                                  <h1 class="text-5xl font-semibold text-white md:text-6xl">
                                    <span class="text-[#ff0] ">The Secret:</span>to Productivity? It's Not What You Think.
                                  </h1>
                                  <div class="max-w-4xl">
                                    <p class="mt-5 text-lg text-neutral-400">
                                      It is a creative hub where imagination meets craftsmanship to transform ideas into tangible realities. At CocoBear Agency, we specialize in turning conceptual visions into concrete forms, whether it be through design, artistry, or technological innovation.
                                    </p>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="relative pt-4 overflow-hidden bg-neutral-900">
                                ...
                                <div class="relative z-10">
                                  <div class="max-w-5xl px-4 mx-auto xl:px-0">
                                    <div class="mb-4">
                                      <h2 class="text-neutral-400">Trusted by Open Source, enterprise, and more than 1,100 of you</h2>
                                    </div>
                                    ...
                                    <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
                                      <div class="mb-5">
                                        ...
                                        <div class="mt-5">
                                          ...
                                          <p class="mt-1 text-neutral-400">With the aim of optimizing customer interactions and boosting brand loyalty, the team at CocoBear leveraged Mailchimp's powerful tools and expertise to deliver exceptional results.</p>
                                        </div>
                                      </div>
                                      <p class="mt-auto">
                                    ...
                                    <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
                                      <div class="mb-5">
                                        ...
                                        <div class="mt-5">
                                          ...
                                          <p class="mt-1 text-neutral-400">In collaboration with Shopify, CocoBear embarked on a mission to revolutionize the e-commerce experience for a fictitious fashion brand, "StyleAura.".</p>
                                        </div>
                                      </div>
                                      <p class="mt-auto">
                                        <span class="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-700 group-hover:border-[#ff0] group-focus:border-[#ff0] transition focus:outline-none">
                                    ...
                                    <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
                                      <div class="mb-5">
                                        ...
                                        <div class="mt-5">
                                          ...
                                          <p class="mt-1 text-neutral-400"> With the goal of accelerating project delivery and enhancing collaboration among development teams, CocoBear leveraged GitLab's comprehensive suite of tools and CocoBear's expertise in digital product development.</p>
                                        </div>
                                      </div>
                                      <p class="mt-auto">
                                        <span class="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-700 group-hover:border-[#ff0] group-focus:border-[#ff0] transition focus:outline-none">
                              ...
                              <div class="bg-neutral-900">
                                <div class="max-w-5xl px-4 py-10 mx-auto xl:px-0 lg:py-20">
                                  <!-- Title -->
                                  <div class="max-w-3xl mb-10 lg:mb-14">
                                    <h2 class="text-2xl font-semibold text-white md:text-4xl md:leading-tight">CocoBear reviews</h2>
                                    ...
                                    <div>
                                      ...
                                      <blockquote>
                                        <p class="text-xl font-medium text-white md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
                                          To say that switching to CocoBear has been life-changing is an understatement. My business has tripled since then.
                                        </p>
                                      ...
                                      <div class="grid items-center grid-cols-1 sm:grid-cols-3 gap-y-20 gap-x-12">
                                        ...
                                        <div class="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                                          ...
                                          <div class="mt-3 sm:mt-5">
                                            ...
                                            <p class="mt-1 text-sm sm:text-base text-neutral-400">CocoBear partners</p>
                                          </div>
                                        </div>
                                        <!-- End Stats -->
                                ...
                                <div class="w-full max-w-5xl px-4 py-10 mx-auto xl:px-0 lg:pt-16">
                                  <div class="inline-flex items-center">
                                    ...
                                    <div class="border-s border-neutral-700 ps-5 ms-5">
                                      <p class="text-sm text-neutral-400">2024 CocoBear Co.</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="fixed bottom-2 sm:bottom-4 end-2 sm:end-4 ms-2 z-[70] bg-neutral-900 border border-neutral-800 rounded-lg dark:bg-neutral-800">
                              ...
                              <div class="flex items-center gap-px">
                                <p class="inline-flex gap-x-2 text-xs text-white py-1 px-2 relative before:absolute before:top-1/2 before:-start-0.5 before:z-10 before:w-px before:h-4 before:bg-white/20 before:-translate-y-1/2 first:before:hidden">
                                  ...
                                  This is the CocoBear UI template preview mode.
                                </p>
                                ...
                                <div class="hs-dropdown relative inline-flex [--strategy:absolute] [--placement:bottom-right] before:absolute before:top-1/2 before:-start-px before:z-10 before:w-px before:h-4 before:bg-white/20 before:-translate-y-1/2 first:before:hidden">
                                  ...
                                  <!-- Dropdown -->
                                  <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-48 transition-[opacity,margin] duration opacity-0 hidden z-10 border border-neutral-800 bg-neutral-900 rounded-lg shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)] dark:bg-neutral-800">
                            ...
                            <!-- JS PLUGINS -->
                            <!-- Required plugins -->
                            <script src="../../assets/vendor/preline/dist/index.js?v=2.3.0"></script>
